...
public class SimplePlanesMod {
    ...
    private void commonSetup(FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            SimplePlanesUpgrades.registerUpgradeItem(SimplePlanesItems.FIREWORK_SHOOTER.get(), SimplePlanesUpgrades.FIREWORK_SHOOTER.get());
            SimplePlanesUpgrades.registerUpgradeItem(SimplePlanesItems.MINI_SHOOTER.get(), SimplePlanesUpgrades.MINI_SHOOTER.get());
