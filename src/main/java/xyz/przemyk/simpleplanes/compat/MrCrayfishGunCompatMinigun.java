...
public class MrCrayfishGunCompatMinigun {
    @SubscribeEvent
    ...
    public static void shooterBehaviour(Item ammoItem, ItemStackHandler itemStackHandler, Level level, Player player, Vec3 motion, double x, double y, double z) {
        if (ammoItem instanceof IAmmo) {
            ...
            GunItem gunItem = (GunItem) MinigunDummy.getItem();
            ...
            ProjectileEntity projectile = projectileFactory.create(level, player, MinigunDummy, gunItem, gun);
            projectile.setWeapon(MinigunDummy);
