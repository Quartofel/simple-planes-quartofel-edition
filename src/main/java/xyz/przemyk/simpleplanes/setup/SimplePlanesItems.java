...
public class SimplePlanesItems {
    ...
    public static final RegistryObject<Item> FIREWORK_SHOOTER = ITEMS.register("firework_shooter", () -> new DescriptionItem(new Item.Properties().tab(ITEM_GROUP), Component.translatable(SimplePlanesMod.MODID + ".shooter_desc", Component.keybind("key.plane_inventory_open.desc"), Component.keybind("key.attack"))));
