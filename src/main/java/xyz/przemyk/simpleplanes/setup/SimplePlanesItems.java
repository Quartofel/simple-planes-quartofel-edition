...
public class SimplePlanesItems {
    ...
    public static final RegistryObject<Item> LAUNCHER = ITEMS.register("launcher", () -> new DescriptionItem(new Item.Properties().tab(ITEM_GROUP), Component.translatable(SimplePlanesMod.MODID + ".shooter_desc", Component.keybind("key.plane_inventory_open.desc"), Component.keybind("key.attack"))));
    public static final RegistryObject<Item> AUTOBOW = ITEMS.register("autobow", () -> new DescriptionItem(new Item.Properties().tab(ITEM_GROUP), Component.translatable(SimplePlanesMod.MODID + ".shooter_desc", Component.keybind("key.plane_inventory_open.desc"), Component.keybind("key.attack"))));
    public static final RegistryObject<Item> MINI_SHOOTER = ITEMS.register("minigun_shooter", () -> new DescriptionItem(new Item.Properties().tab(ITEM_GROUP), Component.translatable(SimplePlanesMod.MODID + ".shooter_desc", Component.keybind("key.plane_inventory_open.desc"), Component.keybind("key.attack"))));
    ...
    public static final RegistryObject<Item> LIQUID_ENGINE = ITEMS.register("liquid_engine", () -> new DescriptionItem(new Item.Properties().tab(ITEM_GROUP), Component.translatable(SimplePlanesMod.MODID + ".press_key", Component.keybind("key.plane_inventory_open.desc"))));
